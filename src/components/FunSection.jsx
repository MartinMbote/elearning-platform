  ...
  return (
    <div>
        ...
        <div className='mt-[0.7vw] ml-[0.5vw] w-[99vw] pb-[4vw] rounded-[0.7vw] bg-strathmore-blue text-white'>
            ...
            <div className='flex flex-wrap ml-[7.5vw] gap-[2vw]'>
                <div className='w-[24vw] h-[15.5vw] border rounded-[0.3vw]'>
                    <div className='ml-[1.4vw] mt-[2.9vw] w-[21vw]'>
                        <p className='font-bold text-[1.2vw] mb-[0.7vw] text-strathmore-yellow'>
                            Flexible Learning
                        </p>
